            ...
            <Card className="bg-slate-900 text-white">
                <CardHeader className="flex flex-row items-center justify-between">
                    <div className="flex justify-between items-center w-full">
                        <div>
                            <CardTitle className="text-3xl">Recent Shipment List</CardTitle>
                            <CardDescription className="text-slate-300">The 10 most recent shipments across all carriers</CardDescription>
                        </div>
                    </div>
                </CardHeader>
                <CardContent>
                    <div className="rounded-md border">
                        <Table>
                            ...
                            <TableBody>
                                {shipments.slice(-10).map((shipment, index) => (
                                    <TableRow key={index}>
